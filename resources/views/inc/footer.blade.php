                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col- -sm-12">
                        <div class="single-footer-widget marbtm50">
                            ...
                            <div class="our-company-info">
                                <div class="text-box">
                                    <p>Our healthcare decontamination company provides thorough and reliable cleaning services, ensuring safety.</p>
                                </div>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="bottom-inner">
                    <div class="copyright">
                        <p>Copyright &copy; {{\Carbon\Carbon::now()->format('Y')}} <a href="/">vicSystems Technologies Ltd.</a> All Rights Reserved.</p>
                    </div>
                </div>
            </div>
        </div>
...
<div id="search-popup" class="search-popup">
    ...
    <div class="popup-inner">
        ...
        <div class="search-form">
            <form method="post" action="https://mehedi.asiandevelopers.com/vicSystems Technologies Ltd.-demo//">
